...
def add_connection(parser):
    parser.add_argument(
        "--base-url", default="http://127.0.0.1:8001", help="AI4Patent application URL"
    )
...
def build_parser():
    parser = argparse.ArgumentParser(description="Deterministic client for the IDEA Workflow API")
